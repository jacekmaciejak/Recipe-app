...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar proxy = exports.proxy = \"https://cors-anywhere.herokuapp.com/\"; //obejscie do strony z API\nvar key = exports.key = \"70e825316658a43a8311c70321ebc460\"; //klucz API ze strony\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //70e825316658a43a8311c70321ebc460\n//Search API URL  https://www.food2fork.com/api/search\n//Recipe details API URL   https://www.food2fork.com/api/get\n\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n//-------------- 2 ----------------\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n  //------------- 1 -------------------\n\n\n  _createClass(Search, [{\n    key: \"getResault\",\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                _context.next = 3;\n                return (0, _axios2.default)(_config.proxy + \"https://www.food2fork.com/api/search?key=\" + _config.key + \"&q=\" + this.query);\n\n              case 3:\n                res = _context.sent;\n                //zamiast metody fetch, dziala na wszystkich przegladarkach, musimy ja zainstalowac, sluzy do pobierania danych, jako parametr dajemy adres API URL, oddzielamy \"?\" i dodajemy kolejne parametry\n                this.result = res.data.recipes;\n                _context.next = 10;\n                break;\n\n              case 7:\n                _context.prev = 7;\n                _context.t0 = _context[\"catch\"](0);\n\n                alert(_context.t0);\n\n              case 10:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 7]]);\n      }));\n\n      function getResault() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResault;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
